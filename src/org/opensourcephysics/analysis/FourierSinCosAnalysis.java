...
public class FourierSinCosAnalysis implements Data {
	...
	/**
	 * Fourier analyzes the given data y[] after adding gutter points at the start
	 * and end of the z[] array.
	 *
	 * @param x      double[]
	 * @param y      double[]
	 * @param gutter int
	...
	/**
	 * Repeats the Fourier analysis of the real data y[] with the previously set
	 * scale and gutter.
	 *
	 * @param y double[]
	...
	public double[] repeatAnalysis(double[] y) {
		...
		System.arraycopy(gutterVec, 0, fftData, fftData.length - 1 - gutterVec.length, gutterVec.length); // zero the
																											// right
																											// gutter
	...
	/**
	 * Sets the radians flag for the frequency values of datasets. Dataset x-values
	 * are either frequencies (cycles) or angular frequencies (radians) depending on
	 * the value of the radians flag.
	 *
	...
	/**
	 * Gets the radians flag. Radians is true if the dataset uses angular frequency
	 * as the x-coordinate.
	 *
	 * @return boolean
	 */
	...
	/**
	 * Gets the datasets that contain the result of the last Fourier analysis. The
	 * power spectrum is contained in the first dataset. Sine coefficients are
	 * contained in the second dataset. Cosine coefficients are in the third
	 * dataset.
	 *
	 * Dataset x-values are either frequencies (cycles) or angular frequencies
	 * (radians) depending on the value of the radians flag.
	 *

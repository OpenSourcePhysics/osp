...
public class TranslatorTool extends JFrame implements Tool, Hidable, Translator {
	 ...
	 * localized value is found, the key is returned.
	 *
	...
	/**
	 * Gets the localized value of a property for the specified object. The object
	 * must first be associated with a class. If no localized value is found, the
	 * key is returned.
	 *

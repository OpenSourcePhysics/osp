...
public class DataFunctionPanel extends FunctionPanel {
	...
	static class Loader implements XML.ObjectLoader {
		...
		public void saveObject(XMLControl control, Object obj) {
			...
			for (FObject next : editor.getObjects()) {
		...
		public Object loadObject(XMLControl control, Object obj) {
			...
			FunctionEditor editor = panel.getFunctionEditor();
			List<FObject> existingFunctions = editor.getObjects();
			...
			outer: for (Object next : functionsToImport) {
				...
				for (Object f : existingFunctions) {
					...
					// if identical function already exists, don't add again
					if (dataFunction.getYColumnName().equals(function[0])
							&& dataFunction.getInputString().equals(function[1])) {
						continue outer;
					}
				}

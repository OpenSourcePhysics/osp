...
public class LibraryJSSearchRefresher implements PropertyChangeListener {
    ...
    void chooseCollectionsToRefresh() {
  	...
  	/**
  	 * Refreshes search data for the next collection path, if any. 
  	 * Exits when all paths have been refreshed.
  	 */
    void refreshNext() {
      t = System.currentTimeMillis();
        ...
        System.out.println("start refreshing "+next);
				...
				System.out.println("finished refreshing "+paths.size()+" collections in " + (t-t0)/1000 +" sec");
	      System.exit(0);
			}   	
    }
    ...
    void uploadToWeb(String localFilePath) {
      ...
      try {
		...
		public void propertyChange(PropertyChangeEvent e) {
			...
			browser.closeTab(0);
			System.out.println("finished refreshing "+ e.getPropertyName() + " in " + (now-t)/1000 + " sec");			
			refreshNext();
		}

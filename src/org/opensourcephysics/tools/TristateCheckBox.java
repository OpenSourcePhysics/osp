...
public class TristateCheckBox extends JCheckBox {
	...
	/**
	 * Set the new state to either SELECTED, NOT_SELECTED or PART_SELECTED. If state
	...
	private class TristateDecorator implements ButtonModel {
		 ...
		 * PART_SELECTED state when the checkbox is selected and armed (grey) and

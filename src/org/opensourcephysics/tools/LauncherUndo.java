...
public class LauncherUndo extends UndoManager {
	...
	/**
	 * Gets the current launcher state. Returns null if launcher is empty or if the
	 * current filename does not refer to an existing file.
	 *
	...
	protected class LoadEdit extends AbstractUndoableEdit {
		...
		/**
		 * Constructor specifies new file and node. Prev file and node are determined
		 * from current launcher state.
		 *
	...
	protected class NavEdit extends AbstractUndoableEdit {
		...
		/**
		 * Constructor. State arrays are [0] String filename (may be null), [1] String
		 * nodepath, [2] Integer pagenumber, [3] URL url (may be null)
		 *

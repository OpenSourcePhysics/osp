 ...
 * image. Worldspace coordinates of the point are its <i>scaled</i> position
...
public class ImageCoordSystem extends OSPRuntime.Supported {
	...
	/**
	 * Sets the fixed origin property. When it is fixed, it is in the same position
	 * at all times. When setting fixed origin to true, this sets all origins to the
	 * position of the origin at frame 0.
	 *
	 ...
	 * Sets the fixed origin property. When it is fixed, it is in the same position
	 * at all times. When setting fixed origin to true, this sets all origins to the
	 * position of the origin at frame n.
	 *
	 * @param fixed <code>true</code> to fix the origin
	 * @param n     the frame number
	 */
	...
	/**
	 * Sets the fixed angle property. When it is fixed, it is the same at all times.
	 * When setting fixed angle to true, this sets all angles to the angle at frame
	 * 0.
	 *
	...
	/**
	 * Sets the fixed scale property. When it is fixed, it is the same at all times.
	 * When setting fixed scale to true, this sets all scales to the scale at frame
	 * 0.
	 *
	...
	/**
	 * Gets the scale factor (image units per world unit) along the image x-axis
	 * (width direction) for the specified frame number.
	 *
	 * @param n the frame number
	...
	/**
	 * Gets the scale factor (image units per world unit) along the image y-axis
	 * (height direction) for the specified frame number.
	 *
	 * @param n the frame number
	...
	/**
	 * Sets the scale factor (image units per world unit) along the image x-axis
	 * (width direction) for the specified frame number.
	 *
	 * @param n     the frame number
	...
	/**
	 * Sets the scale factor (image units per world unit) along the image x-axis
	 * (width direction) for all frames.
	 *
	 * @param value the x scale factor
	 */
	...
	/**
	 * Sets the scale factor (image units per world unit) along the image y-axis
	 * (height direction) for the specified frame number.
	 *
	 * @param n     the frame number
	...
	/**
	 * Sets the scale factor (image units per world unit) along the image y-axis
	 * (height direction) for all frames.
	 *
	 * @param value the y scale factor
	 */
	...
	/**
	 * Sets the scale factors (image units per world unit) along the x-axis and
	 * y-axis of the image for the specified frame number.
	 *
	 * @param n      the frame number
	...
	/**
	 * Sets the scale factors (image units per world unit) along the x-axis and
	 * y-axis of the image for all frames.
	 *
	 * @param valueX the x scale factor
	 * @param valueY the y scale factor
	 */
...
//			if (updateToKeyFrames && keyFrames.size() > 0) {
	...
	/**
	 * Sets the image position of the world origin for all frames in a specified
	 * range.
	 *
	 * @param start  the start frame
	 * @param end    the end frame
	...
	/**
	 * Gets the cosine of the angle of the world x-axis measured ccw from the image
	...
	/**
	 * Gets the sine of the angle of the world x-axis measured ccw from the image
	 * x-axis for the specified frame number.
	 *
	 * @param n the frame number
	...
	/**
	 * Sets the cosine and sine of the angle of the world x-axis measured ccw from
	 * the image x-axis for the specified frame number.
	 *
	 * @param n   the frame number
	...
	/**
	 * Sets the cosine and sine of the angle of the world x-axis measured ccw from
	 * the image x-axis for all frames.
	 *
	 * @param cos the cosine of the angle
	 * @param sin the sine of the angle
	 */
	...
	/**
	 * Gets the angle of the world x-axis measured ccw from the image x-axis for the
	...
	/**
	 * Sets the angle of the world x-axis measured ccw from the image x-axis for the
	 * specified frame number.
	 *
	 * @param n     the frame number
	...
	/**
	 * Sets the angle of the world x-axis measured ccw from the image x-axis for all
	 * frames.
	 *
	 * @param theta the angle in radians
	 */
	...
	/**
	 * Converts the specified image position to a world x position for the specified
	 * frame number.
	 *
	 * @param n      the frame number
	...
	/**
	 * Converts the specified image position to a world y position for the specified
	 * frame number.
	 *
	 * @param n      the frame number
	 * @param imageX the image x position
	...
	/**
	 * Converts the specified world position to an image x position for the
	 * specified frame number.
	 *
	 * @param n      the frame number
	...
	/**
	 * Converts the specified world position to an image y position for the
	 * specified frame number.
	 *
	 * @param n      the frame number
	 * @param worldX the world x position
	...
	/**
	 * Converts the specified image vector components to a world vector x component
	 * for the specified frame number.
	 *
	 * @param n      the frame number
	...
	/**
	 * Converts the specified image vector components to a world vector y component
	 * for the specified frame number.
	 *
	 * @param n      the frame number
	 * @param imageX the image x components
	...
	/**
	 * Converts the specified world vector components to an image vector x component
	 * for the specified frame number.
	 *
	 * @param n      the frame number
	 * @param worldX the world x position
	...
	/**
	 * Converts the specified world vector components to an image vector y component
	 * for the specified frame number.
	 *
	 * @param n      the frame number
	 * @param worldX the world x position
	...
	/**
	 * Gets a copy of the affine transform used to convert from worldspace to
	 * imagespace for the specified frame number.
	 *
	 * @param n the frame number
	...
	/**
	 * Gets a copy of the affine transform used to convert from imagespace to
	 * worldspace for the specified frame number.
	 *
	 * @param n the frame number
	...
	/**
	 * Gets the set of key frames. This returns the actual Set, not a copy, so the
	 * entries can be converted when exporting a video clip/tracker panel
	 * combination.
	 *
	 * @return the Set
	 */
	...
	/**
	 * Updates the transforms used to convert between drawing spaces for the
	 * specified frame number. The toImage transform first rotates about the world
	 * origin by an angle determined by cos and sin, then scales to image units,
	 * then translates to the image origin. The toWorld transform is the inverse.
	 *
	 * @param n the frame number

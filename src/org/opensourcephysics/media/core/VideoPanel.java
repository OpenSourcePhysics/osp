...
public class VideoPanel extends InteractivePanel implements PropertyChangeListener {
	...
	public static final int PROGRESS_VIDEO_LOADING = 8;
	public static final int PROGRESS_VIDEO_READY = 70;
	public static final int PROGRESS_VIDEO_PROCESSING = 10;
				...
				if (video instanceof IncrementallyLoadable) {
					...
					try {
						if (iVideo.loadMoreFrames(VideoIO.incrementToLoad)) {
							...
							videoPanel.progress = PROGRESS_VIDEO_PROCESSING + 1 + (progress % 60);
							return false;					
						} else {

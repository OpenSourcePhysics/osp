...
public class Derivative {
	 ...
	 * drops below defaultNumericalPrecision or if the desired tolerance is reached.
	 *
	 * @param f   the function
	 * @param x0  where derivative is to be calculated
	 * @param h   initial step size
	 * @param tol desired accuracy
	 * @param d6  scratch double[6]
	 * @return first derivative
	 */
	static public double romberg(Function f, double x0, double h, double tol, double[] d6) {

...
public class DataTableFrame extends OSPFrame {
	...
	void setNumberFormat() {
		...
		String str = JOptionPane.showInputDialog(this,
				DisplayRes.getString("DataTableFrame.NumberOfDigits_option_pane_title"), "" + digits); //$NON-NLS-1$ //$NON-NLS-2$
		if (str == null) {
			return;
		}
	...
	public void copy() {
		OSPRuntime.copy(getSelectedData(table.getSelectedRows(), table.getSelectedColumns()).toString(), null);
	}
	...
	public void saveAs() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, DisplayRes.getString("DataTableFrame.SaveErrorMessage"), //$NON-NLS-1$
					DisplayRes.getString("DataTableFrame.Error"), JOptionPane.ERROR_MESSAGE); //$NON-NLS-1$
		}
	}

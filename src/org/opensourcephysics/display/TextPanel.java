...
/**
 * The TextPanel renders text in a component. The text is surrounded by a
 * border.
 *
...
public class TextPanel extends JPanel {
	...
	private static String fixText(String _text) {
		return (_text == null ? "" : TeXParser.parseTeX(_text));
	}
	...
	public void setText(String _text) {
		...
		c.validate();
// BH -- don't we want this?		c.repaint();
//		// BH ? How does this help? Layout but no refresh??
//		OSPRuntime.postEvent(() -> { c.validate();});
	}

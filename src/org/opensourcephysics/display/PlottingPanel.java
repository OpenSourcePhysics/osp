...
//    axes = new CartesianType1(this);
	...
	/**
	 * Sets the label and font for the X (horizontal) axis. If the font name is
	 * null, the font is unchanged.
	 *
	 * @param label     the label
	...
	/**
	 * Sets the label and font for the Y (vertical) axis. If the font name is null,
	 ...
	 *
	 * Gutters are usually set by the axes to insure that there is enough space for
	 * axes labels. Other objects can, however, perform this function by
	 * implementing the Dimensioned interface.
	 */
	@Override
	...
	protected void paintFirst(Graphics g) {
		...
		if ((leftGutterPreferred > 0) || (topGutterPreferred > 0) || (rightGutterPreferred > 0)
				|| (bottomGutterPreferred > 0)) {

...
public class DataClip {
	...
	private static final String PROPERTY_DATACLIP_ADJUSTING = "adjusting";
	...
	/**
	 * Sets the clip length (number of video frames on which the data is displayed).
	 * If the clip length is set to zero or less then it is reported as equal to the
	 * entire data length.
	 *
	...
	/**
	 * Gets the clip length (number of video frames on which the data is displayed
	 * unless limited by the video clip or stride).
	 *
	...
	/**
	 * Gets the available clip length (step count). A step is available if it's
	 * index is less than the data length. Available clip length <= clip length
	 *
	 * @return the index
	 */
	...
	/**
	 * Converts data index to step number. An index that falls between two steps
	 * maps to the previous step.
	 *
	...
	public void setAdjusting(boolean adjusting) {
		...
		support.firePropertyChange(PROPERTY_DATACLIP_ADJUSTING, null, adjusting); //$NON-NLS-1$
	}

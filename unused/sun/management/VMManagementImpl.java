...
class VMManagementImpl implements VMManagement {
    ...
    static {  // WC: native methods not allowed in JavaScript
        version = (org.opensourcephysics.js.JSUtil.isJS)?"0":getVersion0();
        if (version == null) {
            throw new AssertionError("Invalid Management Version");
        }
        if(!org.opensourcephysics.js.JSUtil.isJS)initOptionalSupportFields();
    }
    ...
    public String   getCompilerName() {
    	if(org.opensourcephysics.js.JSUtil.isJS) return "SwingJS";  //WC: doPrivileged not supported in JavaScript
